...
import com.Michael.AccountBook.SPUtils;
...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (url.length()>0) {
            ...
            // final String dbPath = getActivity().getApplicationContext().getDir("db",Context.MODE_PRIVATE).getPath();
