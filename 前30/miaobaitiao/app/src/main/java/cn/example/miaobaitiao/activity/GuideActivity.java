...
public class GuideActivity extends AppCompatActivity {
    ...
    private void setListener() {
        ...
        mBackgroundBanner.setEnterSkipViewIdAndDelegate(R.id.btn_guide_enter, R.id.tv_guide_skip, new BGABanner.GuideDelegate() {
            ...
            public void onClickEnterOrSkip() {
                ...
                intent.setClass(GuideActivity.this,Login2Activity.class);
    ...
    private void processLogic() {
        // 设置数据源
        mBackgroundBanner.setData(R.drawable.lod_01, R.drawable.lod_02, R.drawable.lod_03, R.drawable.lod_04);
